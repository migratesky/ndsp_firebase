...
import { LayoutDashboard, School, Users, FileEdit, LogOut, PlusCircle, Edit, Trash2, KeyRound, Search } from "lucide-react";

// Mock data for users
const mockAdminUsers = [
  { id: '1', username: 'admin_user', role: 'Administrator', lastLogin: '2024-07-28 10:00 AM' },
  { id: '2', username: 'editor_user', role: 'Content Editor', lastLogin: '2024-07-27 03:00 PM' },
  { id: '3', username: 'viewer_user', role: 'Viewer', lastLogin: '2024-07-28 09:00 AM' },
];
                ...
                {mockAdminUsers.map((user) => (
                  <TableRow key={user.id}>
                    ...
                    <TableCell className="space-x-1">
                      <Button variant="outline" size="icon" title="Edit User"><Edit className="h-4 w-4" /></Button>
                      <Button variant="outline" size="icon" title="Reset Password"><KeyRound className="h-4 w-4" /></Button>
                      <Button variant="destructive" size="icon" title="Delete User"><Trash2 className="h-4 w-4" /></Button>
                    </TableCell>
                  </TableRow>
                ))}
              </TableBody>
